                                ...
                                <div class="row">
                                        ...
                                        <div class="email-app mb-4">
                                                <nav>
                                                    ...
                                                    <ul class="nav">
                                                        <li class="nav-item">
                                                            <a class="nav-link" href="#"><i class="fa fa-inbox"></i> Inbox @if($count != "0") <span class="badge badge-danger">{{$count}}</span> @endif </a>
                                                        </li>
                                                     
                                                        <li class="nav-item">
                                                            <a class="nav-link" href="{{URL::to('home/enterpriseSentMsgs')}}/{{$sender_e_id}}/{{$reciever_e_id}}"><i class="fa fa-rocket"></i> Sent <span class="btn-link">{{$sentcount}}</span></a>
                                                        </li>
                                                ...
                                                <main class="inbox">
                                                    ...
                                                    <ul class="messages">
                                                        @foreach($msgs as $m)
                                                        <li class="message {{$m->status == 0 ? 'unread' : ''}}">
